...
[v1.0.1](https://github.com/Drichards124/dbt-costgate/releases/latest).
...
- [x] **pull the published image** — `ghcr.io/drichards124/dbt-costgate:v1.0.1`, pushed on every release
